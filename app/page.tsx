    ...
    <main style={styles.page}>
      <section style={styles.hero}>
          ...
          <div style={styles.brandSection}>
            ...
            <div>
              ...
              <p style={styles.subtitle}>
                Claim LBP every 24 hours and use it to mint NFTs, collectibles,
        ...
        <div style={styles.tabs}>
          <button onClick={() => setActiveTab("about")} style={activeTab === "about" ? styles.activeTab : styles.tab}>
            About
          </button>
          <button onClick={() => setActiveTab("claim")} style={activeTab === "claim" ? styles.activeTab : styles.tab}>
            Claim LBP
          </button>
          <button onClick={() => setActiveTab("marketplace")} style={activeTab === "marketplace" ? styles.activeTab : styles.tab}>
            Marketplace
          </button>
        </div>
      </section>
        ...
        <>
          <section style={styles.aboutSection}>
            ...
            <p style={styles.aboutText}>
              LBP Coin is a community token on Arc Network. This marketplace
              lets users collect LBP and spend it on digital assets, starting
              with Catholic Church NFTs and expanding into Lebanese heritage,
              cultural, and community collections.
            </p>
          </section>
          ...
          <section style={styles.tokenomicsSection}>
            ...
            <div style={styles.statGrid}>
              <div style={styles.statCard}><strong>Token Name</strong><span>Lebanese Pound Coin</span></div>
              <div style={styles.statCard}><strong>Symbol</strong><span>LBP</span></div>
              <div style={styles.statCard}><strong>Network</strong><span>Arc Testnet</span></div>
              <div style={styles.statCard}><strong>Decimals</strong><span>18</span></div>
              <div style={styles.statCard}><strong>Daily Claim</strong><span>1,000 LBP</span></div>
              <div style={styles.statCard}><strong>Utility</strong><span>NFT Marketplace</span></div>
            </div>
          </section>
          ...
          <section style={styles.roadmapSection}>
            ...
            <div style={styles.roadmapGrid}>
              <div style={styles.roadmapCard}><h3>Phase 1</h3><p>Launch LBP Coin on Arc Network</p></div>
              <div style={styles.roadmapCard}><h3>Phase 2</h3><p>Launch Church NFT Collection</p></div>
              <div style={styles.roadmapCard}><h3>Phase 3</h3><p>Lebanese Heritage Collections</p></div>
              <div style={styles.roadmapCard}><h3>Phase 4</h3><p>Open Community Marketplace</p></div>
            </div>
          </section>
        </>
      )}
          ...
          <div style={styles.coinHeader}>
            ...
            <div>
              ...
              <p style={styles.coinText}>
                Claim 1,000 LBP once every 24 hours. LBP is used inside the
      ...
      {activeTab === "marketplace" && (
        <section style={styles.categorySection}>
          <h2 style={styles.sectionTitle}>Catholic Church NFTs</h2>
          <p style={styles.categoryDescription}>
            Mint collectible Catholic Church NFTs using LBP Coin.
          </p>
            ...
            {CHURCHES.map((church) => (
              <div key={church.id} style={styles.card}>
                ...
                <ClaimButton
                  ...
                  claimParams={{ type: "ERC721", quantity: BigInt(1) }}
      ...
      <section style={styles.contractSection}>
        ...
        <div style={styles.contractGrid}>
          <a style={styles.contractCard} href={`https://testnet.arcscan.app/address/${LBP_COIN_ADDRESS}`} target="_blank" rel="noreferrer">
            <strong>LBP Coin Contract</strong>
            <span>{LBP_COIN_ADDRESS}</span>
          </a>
          <a style={styles.contractCard} href={`https://testnet.arcscan.app/address/${CHURCH_NFT_ADDRESS}`} target="_blank" rel="noreferrer">
...
const styles: Record<string, React.CSSProperties> = {
  ...
  hero: { border: "1px solid #222", background: "linear-gradient(135deg, #111 0%, #171717 60%, #0b2a1a 100%)", borderRadius: 18, padding: 24, marginBottom: 24 },
  ...
  smallLogo: { borderRadius: "50%", border: "1px solid #333", background: "#111" },
  title: { margin: 0, fontSize: 38, lineHeight: 1.1 },
  subtitle: { marginTop: 10, opacity: 0.8, maxWidth: 760, lineHeight: 1.5 },
  tabs: { display: "flex", gap: 10, marginTop: 24, flexWrap: "wrap" },
  tab: { padding: "10px 14px", borderRadius: 8, border: "1px solid #333", background: "#111", color: "white", cursor: "pointer", fontWeight: "bold" },
  activeTab: { padding: "10px 14px", borderRadius: 8, border: "1px solid #16a34a", background: "#16a34a", color: "white", cursor: "pointer", fontWeight: "bold" },
  infoBox: { border: "1px solid #222", background: "#111", borderRadius: 12, padding: 14, marginBottom: 24 },
  wallet: { opacity: 0.75, margin: 0, wordBreak: "break-all" },
  status: { color: "#7dd3fc", marginTop: 10, marginBottom: 0 },
  coinSection: { border: "1px solid #333", background: "#111", borderRadius: 16, padding: 20, marginBottom: 28 },
  coinHeader: { display: "flex", alignItems: "center", gap: 14 },
  aboutSection: { border: "1px solid #222", background: "#0f0f0f", borderRadius: 16, padding: 20, marginBottom: 32 },
  sectionTitle: { marginBottom: 10 },
  coinText: { opacity: 0.75, marginBottom: 16 },
  aboutText: { opacity: 0.78, lineHeight: 1.6, maxWidth: 900 },
  statGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 12, marginTop: 18 },
  statCard: { border: "1px solid #2a2a2a", background: "#151515", borderRadius: 12, padding: 14, display: "flex", flexDirection: "column", gap: 6 },
  coinButton: { padding: "11px 14px", background: "#16a34a", border: "none", color: "white", borderRadius: 8, fontWeight: "bold", cursor: "pointer" },
  tokenomicsSection: { border: "1px solid #222", background: "#0f0f0f", borderRadius: 16, padding: 20, marginBottom: 32 },
  roadmapSection: { border: "1px solid #222", background: "#0f0f0f", borderRadius: 16, padding: 20, marginBottom: 32 },
  ...
  categoryDescription: { opacity: 0.7, marginBottom: 16 },
  ...
  button: { width: "100%", marginTop: 10, padding: "10px 12px", background: "#2563eb", border: "none", color: "white", borderRadius: 8, fontWeight: "bold", cursor: "pointer" },
  contractSection: { border: "1px solid #222", background: "#0f0f0f", borderRadius: 16, padding: 20, marginBottom: 32 },
  ...
  contactSection: { border: "1px solid #333", background: "#111", borderRadius: 16, padding: 20, marginTop: 32 },
  contactText: { opacity: 0.75, marginBottom: 14 },
  emailButton: { display: "inline-block", padding: "11px 14px", background: "#991b1b", color: "white", borderRadius: 8, textDecoration: "none", fontWeight: "bold" },
  footer: { marginTop: 28, paddingTop: 18, borderTop: "1px solid #222", opacity: 0.75 },
  disclaimer: { fontSize: 13, opacity: 0.65 },
};